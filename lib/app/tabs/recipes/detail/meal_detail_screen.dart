                            ...
                            child: Container(
                              ...
                              child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    for (int i = 0; i < snapshot.data['Ingredient'].length; i++)
                                        ...
                                        child: Row(
                                            children: <Widget>[
                                              ...
                                              Padding(
                                                  padding: const EdgeInsets
                                                      .fromLTRB(30, 0, 0, 0),
                                                  child: Text(snapshot.data['Ingredient'][i].toString(),
                                                      style: TextStyle(
                                                          fontFamily: 'Rubik')
                                                  )
                                              ),
                                  ...
                                  //  for(var item in snapshot.data['Direction'])
                                    for (int i = 1; i <= snapshot.data['Direction'].length; i++)
                                            ...
                                            children: <Widget>[
                                              ...
                                              Padding(
                                                  padding: const EdgeInsets
                                                      .fromLTRB(20, 20, 0, 0),
                                                  child: Text(
                                                      snapshot.data['Direction'][i-1].toString(),
                                                      style: TextStyle(
                                                          fontFamily: 'Rubik')
                                                  )
                                              ),
