...
class MealDetailScreen extends StatefulWidget {
  ...
  class _MealDetailScreenState extends State<MealDetailScreen> {
    ...
    void _Follow(String recipeOwnerID){
      ...
      FirebaseFirestore.instance.collection('User_Profile').doc(_auth.currentUser.uid).collection('Relation_Detail').doc('Following').update({'UserUID' : FieldValue.arrayUnion(temp)});
      FirebaseFirestore.instance.collection('User_Profile').doc(recipeOwnerID).update({'Follower' : FieldValue.increment(1)});
      FirebaseFirestore.instance.collection('User_Profile').doc(_auth.currentUser.uid).update({'Following' : FieldValue.increment(1)});
    }

    void _UnFollow(String recipeOwnerID){
      List<String> temp =[];
      temp.add(recipeOwnerID);
      FirebaseFirestore.instance.collection('User_Profile').doc(_auth.currentUser.uid).collection('Relation_Detail').doc('Following').update({'UserUID' : FieldValue.arrayRemove(temp)});
      FirebaseFirestore.instance.collection('User_Profile').doc(recipeOwnerID).update({'Follower' : FieldValue.increment(-1)});
      FirebaseFirestore.instance.collection('User_Profile').doc(_auth.currentUser.uid).update({'Following' : FieldValue.increment(-1)});
    }
  ...
  _FollowButton(String recipeOwnerID){
      return StreamBuilder(
          stream: FirebaseFirestore.instance.collection('User_Profile').doc(_auth.currentUser.uid).collection('Relation_Detail').doc('Following').snapshots(),
          builder: (context, snapshot){
            ...
            else if(snapshot.hasData && snapshot.data['UserUID'].contains(recipeOwnerID)){
              return Expanded(
                  flex: 2,
                  child: Padding(
                    padding: const EdgeInsets
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("Recipes")
            ...
            if (!snapshot.hasData) {
              ...
              return StreamBuilder(
              stream: FirebaseFirestore.instance.collection('User_Profile')
                          ...
                          child: Container(
                            ...
                            child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                        children: <Widget>[
                                                          ...
                                                          children: <
                                                            ...
                                                            TextSpan(
                                                                ...
                                                                style: TextStyle(
                                                                    ...
                                                                    fontFamily: 'Rubik')),
                                                            TextSpan(
                                                                text: "${snapshot2.data['Recipes'].toString()} Recipes",
                                                                style: TextStyle(
                                                                    fontFamily: 'Rubik',
                                                                    color: Colors
                                                                        .grey)),
                                          ...
                                          _FollowButton(snapshot.data['UserUID']),
                                          Expanded(
                                            flex: 2,
                                            child: Row(
                                                              children: <
                                  ...
                                  for (int i = 0; i <
                                      snapshot.data['Ingredient'].length; i++)
                                        ...
                                        child: Row(
                                            children: <Widget>[
                                              ...
                                              Padding(
                                                  padding: const EdgeInsets
                                                      .fromLTRB(30, 0, 0, 0),
                                                  child: Text(firstToUpper(snapshot
                                                      .data['Ingredient'][i]
                                                      .toString()),
                                                      style: TextStyle(
                                                          fontFamily: 'Rubik')
                                  ...
                                  for (int i = 1; i <=
                                      snapshot.data['Direction'].length; i++)
