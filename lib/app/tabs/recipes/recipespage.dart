...
class _RecipesViewState extends State<RecipesView> {
  ...
  Future<List> recommendQuery() async{
    ...
    DocumentReference userRecommend = FirebaseFirestore.instance.collection('User_Profile').doc(_auth.currentUser.uid).collection('Relation_Detail').doc('Recommend');
    ...
    for(int i =0; i<_RecommendReturn.length; i++){
      temp = await FirebaseFirestore.instance.collection('Recipes').doc(_RecommendReturn[i]).get();
      RecRecipe.add(temp);
    }
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: NetworkImage(snapshot3.data.docs[index]['ImageURL'])),
                                      ),
                                    ),
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                  fit: BoxFit.cover,
                                                  image: NetworkImage(snapshot4.data[index]['ImageURL'])),
                                              color: Colors.deepOrangeAccent),
                                        ),
                                        SizedBox(
                                          width: 21,
